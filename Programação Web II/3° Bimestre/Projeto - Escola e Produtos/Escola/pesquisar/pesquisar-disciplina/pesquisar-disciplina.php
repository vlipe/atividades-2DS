...
<head>
    ...
    <link rel="stylesheet" href="../pesquisar-disciplina/pesquisar-disciplina.css">
        ...
        <div class="conteudo">
            ...
            <div class="container">
                ...
                <form action="" method="post" name="cliente">
                    <fieldset id="a">
                        <legend>Informe o nome da Disciplina desejada:</legend>
                        <p>Nome: <input type="text" name="txtnome" placeholder="Nome da Disciplina"></p>
                    ...
                    <fieldset id="b">
                        ...
                        if (isset($_POST['btnenviar'])) {
                            ...
                            $p = new Disciplina();
                            $p->setCodDisciplina($_POST['txtnome'] . '%');
                            $pro_bd = $p->consultar();

                            foreach ($pro_bd as $pro_mostrar) {
                                echo "Código: " . $pro_mostrar[0] . "<br>";
                                echo "Cód. Disciplina: " . $pro_mostrar[1] . "<br><br>";
                            }
                        }
                        ?>
                    </fieldset>
