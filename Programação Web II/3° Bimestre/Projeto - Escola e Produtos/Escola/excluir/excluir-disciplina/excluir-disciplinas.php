...
<head>
  ...
  <link rel="stylesheet" href="../excluir-disciplina/excluir-disciplinas.css" />
...
<body>
  ...
  <div class="tudo">
    <div class="conteudo">
      ...
      <h2>Exclua disciplinas na escola</h2>

      <form class="formulario-disciplina" action="" method="post" name="curso">
        <fieldset id="a">
          <legend>Informe o Código da disciplina desejada:</legend>
          <p>Código: <input type="text" name="txtdisciplina" placeholder="Código do Disciplina" /></p>
      ...
      if (isset($btnenviar)) {
          ...
          $p = new Disciplina();
          $p->setCodDisciplina($txtdisciplina);
